...
function getGameRating() {
	var rating = 5;
	var unsuccessfulMovesCount = movesCounter - matchCounter;

	if (unsuccessfulMovesCount > 0)
		rating -= unsuccessfulMovesCount / decreaseGameRatingEveryXUnsuccessfulMoves;
...
function winTheGame() {
	...
	if (getGameRating() < 5)
		$("#wonGameModalChallenge").show(); // show "Keep improving!" message in the modal
